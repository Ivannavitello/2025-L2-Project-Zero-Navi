...
# print(f"The item with the lowest unit price is: {recommendation} KG/L")
# print(f"the item with the lowest amount price cost is: {recommendation_amount} ")
...
unitless_item_recommendation_string = make_statement(f"The item with the lowest amount price cost is: {recommendation_amount} ","*")
